...
public class ProblemSet2 {
    ...
    public static void main(String[] args) {
        ...
        double hexArea = (3 * Math.pow(3, 0.5) * Math.pow(hexSide, 2)) / 2;
        ...
        System.out.print("\nEnter a string: ");
        String reverseMe = in.next();
        
        int index = (int) Math.ceil(reverseMe.length() / 2);
        String firstHalf = reverseMe.substring(0, index);
        String secondHalf = reverseMe.substring(index);
        ...
        String nameMiddle = in.next();

        System.out.print("Enter your last name: ");
        String nameLast = in.next();

        String initials = String.valueOf(nameFirst.charAt(0)) + String.valueOf(nameMiddle.charAt(0)) + String.valueOf(nameLast.charAt(0));
        System.out.printf("\n%S\n\n", initials);
